...
<div<?php print $css_id ? " id=\"$css_id\"" : ''; ?> class="page-wrapper">
  ...
  <?php if (!empty($content['branding'])): ?>
    <div class="page-branding-wrapper main-container container">
  ...
  <?php if (!empty($content['nav'])): ?>
    <div class="page-nav-wrapper navbar container navbar-default">
      <div class="region container-48 clearfix">
  ...
  <?php if (!empty($content['main'])): ?>
    <div class="page-body-wrapper main-container container">
      <div class="region container-48 clearfix">
  ...
  <?php if (!empty($content['footer'])): ?>
    <div class="page-closure-wrapper footer container">
      <div class="region container-48 clearfix">
